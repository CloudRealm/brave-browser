...
const util = {
  ...
  updateBranding: () => {
    ...
    const braveUIResourcesDir = path.join(config.projects['brave-core'].dir, 'ui', 'resources')
    ...
    fileMap.add([path.join(braveUIResourcesDir , 'default_100_percent'), path.join(chromeUIResourcesDir, 'default_100_percent')])
    fileMap.add([path.join(braveUIResourcesDir , 'default_200_percent'), path.join(chromeUIResourcesDir, 'default_200_percent')])
